...
function Vehicle(brand, model, year, mileage) {
  //  Записуєм в this.brand значення аргументу brand, в this.model
  // значення аргументу model і так далі зі всіми аргументами
  this.brand = brand;
  this.model = model;
  this.year = year;
...
// Рядковому представленю Vehicle призначаємо функцію яка повертає
// рядок: <brand> <model> <year>
...
function Car(brand, model, year, mileage, fuelType, speed) {
  // Викликаємо конструктор Vehicle за допомогою apply, передаємо в нього this,
  // [brand, model, year, mileage].
  // Записуєм в this.fuelType значення аргументу fuelType, в this.speed
  // значення аргументу speed
...
// Рядковому представленю прототипу Car призначаємо функцію яка повертає
// рядок: <brand> <model> <year> - <fuelType>.
Car.prototype.toString = function () {
  return Vehicle.prototype.toString.call(this) + "-" + this.fuelType;
};

// Cтворюємо метод accelerate для прискорення швидкості прототипу Car, збільшує
// this.speed на передане число та виводить рядок в консоль:
...
// та виводить рядок в консоль: Автомобіль <brand> <model> зменшив
// до швидкості <speed> км/год
...
function Truck(
  ...
  // Записуємо в this.color значення аргументу color, в this.engineType значення
  // аргументу engineType і так далі зі всіми аргументами
...
// towingCapacity виводить рядок в консоль: Навантаження занадто важке для
// буксирування, якщо ні то рядок Тягнення навантаження...
Truck.prototype.specific = function (load) {
  if (load > this.towingCapacity) {
    console.log("Навантаження занадто велике для буксирування");
  } else {
...
// Це створює нову функцію, в якій this постійно встановлено на car, незалежно
// від того, як функцію викликають.
...
// Перевизначаємо toString для прототипу ElectricCar
// він має повертати <brand> <model> <year> - Батарея: <batteryCapacity> kWh
